...
- تغییرات `odom -> base_link` باید **smooth و پیوسته** باشد (برای کنترل)
    
- تغییرات`map -> odom` ممکن است **jump** داشته باشد (برای اصلاح drift)
    
-  درنهایت  `map -> base_link` “درست” می‌ماند.